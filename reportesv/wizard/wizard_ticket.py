...
class wizard_sv_ticket_report(models.TransientModel):
    ...
    #stock_location_id=fields.Many2one('stock.location', string="Sucursal", help="Sucursal de la que se desea el Libro de IVA",default=lambda self: self.env.user.x_sucursal_id.id)
    ...
    def print_ticket_sales_report(self):
        ...
        return self.env.ref('reportesv.report_ticket_sales_pdf').report_action(self, data=datas)
